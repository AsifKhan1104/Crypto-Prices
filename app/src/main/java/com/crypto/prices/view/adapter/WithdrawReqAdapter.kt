...
class WithdrawReqAdapter(var requests: ArrayList<WithdrawReq>) :
    RecyclerView.Adapter<WithdrawReqAdapter.WithdrawViewHolder>() {
    ...
    class WithdrawViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(req: WithdrawReq) {
            ...
            /*if(req.status.equals("completed", true)){
                holderView.setBackgroundColor(Color.parseColor("#3ddc84"))
            } else {
